    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=4, default=0, max_digits=4,
                                                 verbose_name='Географическая широта местонахождения транспорта')),
                ('longitude', models.DecimalField(decimal_places=4, default=0, max_digits=4,
                                                  verbose_name='Географическая долгота местонахождения транспорта')),
                ('minutePrice', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=4, null=True,
                                                    verbose_name='Цена аренды за минуту')),
                ('dayPrice', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=4, null=True,
